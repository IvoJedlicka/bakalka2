...
let maticeText = [
    ...
    "Příprava na vyučování má rezervy, často nemá v pořádku některé pomůcky na vyučovací hodinu. Většina domácích úkolů je vypracována uspokojivě.
*V případě absence si bez upozornění učitele nedoplní samostatně učivo.",
        "Na vyučovací hodiny se většinou nepřipravuje, často chybí potřebné pomůcky. Projevuje se časté neplnění povinností a domácích úkolů.
*V případě absence si bez opakovaného upozornění učitele nedoplní učivo.",
        "Na vyučování se
nepřipravuje, nenosí předepsané pomůcky. Má liknavý přístup k povinnostem a neplní zadané úkoly.
*Ani po upozornění učitele není učivo doplněné.
]
];
